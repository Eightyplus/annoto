...
public class ColorPickerView extends View {
  ...
  public ColorPickerView(Context c, ColorPickerDialog.OnColorChangedListener l, int color) {
    super(c);
    mListener = l;
    mColors = new int[] {
  ...
  public void setOnColorChangedListener(ColorPickerDialog.OnColorChangedListener mListener) {
